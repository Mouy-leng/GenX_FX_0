...
def main():
    ...
    # Required secrets
    required_secrets = [
        "SECRET_KEY", "DB_PASSWORD", "MONGO_PASSWORD", "REDIS_PASSWORD",
        "BYBIT_API_KEY", "BYBIT_API_SECRET", "FXCM_API_TOKEN",
        "GEMINI_API_KEY", "DISCORD_TOKEN", "TELEGRAM_TOKEN", "AMP_TOKEN"
    ]

    # Required variables
    required_variables = [
        "NODE_ENV", "LOG_LEVEL", "PORT", "API_PORT", "GEMINI_MODEL",
    ...
    missing_environments = [e for e in required_environments if e not in current_environments]
